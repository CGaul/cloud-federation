...
## from the cloudnet-2 mininet topo to the     ##
...
printHelp(){
	echo "--ofc_ip is a required parameter!"
        ...
        echo "all arguments:"
        echo "bash ./map1to1-cloud2.ovxctl.sh --ofc_ip 192.168.1.100 --ofc_port 12345 --tenant 2"
}
...
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:11:00 1
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:11:00 2
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:11:00 3
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:11:00 4

# Switch 3 (:23:00):
echo "Creating Ports (1,2,3) for SWITCH-3..."
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:12:00 1
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:12:00 2
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:12:00 3

# Switch 4 (:24:00):
echo "Creating Ports (1,2) for SWITCH-4..."
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:13:00 1
python2 ovxctl.py -n createPort ${t_id} 00:00:00:00:00:02:13:00 2



# Connect Switches with each other:
# GW 1 <-> GW2:
echo "Connecting Link: (GW-1, GRE-Tunnel Port 2) <-> (GW-2, GRE-Tunnel Port 2)..."
python2 ovxctl.py -n connectLink ${t_id} 00:a4:23:05:00:02:10:00 2 00:a4:23:05:00:01:10:00 2 spf 1
