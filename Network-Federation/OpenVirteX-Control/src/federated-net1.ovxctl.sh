...
python2 ovxctl.py -n createSwitch 1 00:00:00:00:00:02:10:00 #:02

echo "Establishing internal Switches 1.1 & 2.1 ..."
python2 ovxctl.py -n createSwitch 1 00:00:00:00:00:01:11:00 #:03
python2 ovxctl.py -n createSwitch 1 00:00:00:00:00:02:11:00 #:04
...
python2 ovxctl.py -n createPort 1 00:00:00:00:00:01:10:00 1
python2 ovxctl.py -n createPort 1 00:00:00:00:00:01:10:00 2

echo "Establishing Ports (1,2) for GW-2 Switch..."
python2 ovxctl.py -n createPort 1 00:00:00:00:00:02:10:00 1
...
python2 ovxctl.py -n connectLink 1 00:a4:23:05:00:01:10:00 2 00:a4:23:05:00:02:10:00 2 spf 1

# GW 1 <-> Switch 1.1:
echo "Connecting Link: (GW-1, Port 1) <-> (SWITCH-1.1, Port 3)..."
python2 ovxctl.py -n connectLink 1 00:a4:23:05:00:01:10:00 1 00:a4:23:05:00:01:11:00 3 spf 1

# GW 2 <-> Switch 2.1:
echo "Connecting Link: (GW-2, Port 1) <-> (SWITCH-2.1, Port 3)..."
python2 ovxctl.py -n connectLink 1 00:a4:23:05:00:02:10:00 1 00:a4:23:05:00:02:11:00 3 spf 1
...
python2 ovxctl.py -n connectHost 1 00:a4:23:05:00:01:11:00 1 00:00:00:00:01:11
...
python2 ovxctl.py -n connectHost 1 00:a4:23:05:00:02:11:00 1 00:00:00:00:02:11
