...
# Prepares a federateable Network from OVX-1 on OFC-1. 
# Awaits a call of OVX-2 on OFC-1 from the other cloudnet-2 via federated-net1-2.ovxctl.sh
...
echo "Establishing internal Switches 1.1 ..."
python2 ovxctl.py -n createSwitch 1 00:00:00:00:00:01:11:00 #:02
...
#python2 ovxctl.py -n connectLink 1 00:a4:23:05:00:00:00:02 1 00:a4:23:05:00:00:00:04 3 spf 1
...
python2 ovxctl.py -n connectHost 1 00:a4:23:05:00:00:00:02 1 00:00:00:00:01:11
