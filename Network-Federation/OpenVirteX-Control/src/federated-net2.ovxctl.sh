...
python ovxctl.py -n connectLink 2 00:a4:23:05:00:00:00:01 1 00:a4:23:05:00:00:00:03 3 spf 1

# GW 2 <-> Switch 2.1:
echo "Connecting Link: (GW-2, Port 2) <-> (SWITCH-2.1, Port 3)..."
python ovxctl.py -n connectLink 2 00:a4:23:05:00:00:00:02 1 00:a4:23:05:00:00:00:04 3 spf 1
...
#python ovxctl.py -n connectHost 2 00:a4:23:05:00:00:00:03 1 00:00:00:00:01:11
echo "Connecting Host: h1_1_2 <-> SWITCH-1.1..."
python ovxctl.py -n connectHost 2 00:a4:23:05:00:00:00:03 2 00:00:00:00:01:12

# Switch 2.1 ([Port 1: Host 1], [Port 2: Host 2]):
#echo "Connecting Host: h2_1_1 <-> SWITCH-2.1..."
#python ovxctl.py -n connectHost 2 00:a4:23:05:00:00:00:04 1 00:00:00:00:02:11
echo "Connecting Host: h2_1_2 <-> SWITCH-2.1..."
python ovxctl.py -n connectHost 2 00:a4:23:05:00:00:00:04 2 00:00:00:00:02:12
