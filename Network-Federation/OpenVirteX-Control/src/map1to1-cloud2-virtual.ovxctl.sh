...
## from the virt. cloudnet-2 mininet topo to the ##
...
printHelp(){
	echo "--ofc_ip is a required parameter!"
        ...
        echo "bash ./map1to1-cloud2-virtual.ovxctl.sh --ofc_ip 192.168.1.100 (defaults to port 10.000)"
        echo "all arguments:"
        echo "bash ./map1to1-cloud2-virtual.ovxctl.sh --ofc_ip 192.168.1.100 --ofc_port 12345 --tenant 2"
}
...
python2 ovxctl.py -n createNetwork tcp:${ofc_ip}:${ofc_port} 10.0.3.0 16

# For each physical Switch create a virtual switch:
# Home Gateway Switch:
echo "Creating Gateway-1 Switch..."
python2 ovxctl.py -n createSwitch ${t_id} 00:a4:23:05:00:02:10:00 #00:00:00:00:00:02:10:00

# Local (inner) Switches:
echo "Creating internal Switches 1-3..."
python2 ovxctl.py -n createSwitch ${t_id} 00:a4:23:05:00:02:11:00 #00:00:00:00:00:02:11:00
python2 ovxctl.py -n createSwitch ${t_id} 00:a4:23:05:00:02:12:00 #00:00:00:00:00:02:12:00
python2 ovxctl.py -n createSwitch ${t_id} 00:a4:23:05:00:02:13:00 #00:00:00:00:00:02:13:00
...
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:10:00 1 #00:00:00:00:00:02:10:00 1
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:10:00 2 #00:00:00:00:00:02:10:00 2
...
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:11:00 1 #00:00:00:00:00:02:11:00 1
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:11:00 2 #00:00:00:00:00:02:11:00 2
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:11:00 3 #00:00:00:00:00:02:11:00 3
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:11:00 4 #00:00:00:00:00:02:11:00 4

# Switch 3 (:23:00):
echo "Creating Ports (1,2,3) for SWITCH-3..."
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:12:00 1 #00:00:00:00:00:02:12:00 1
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:12:00 2 #00:00:00:00:00:02:12:00 2
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:12:00 3 #00:00:00:00:00:02:12:00 3

# Switch 4 (:24:00):
echo "Creating Ports (1,2) for SWITCH-4..."
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:13:00 1 #00:00:00:00:00:02:13:00 1
python2 ovxctl.py -n createPort ${t_id} 00:a4:23:05:00:02:13:00 2 #00:00:00:00:00:02:13:00 2
