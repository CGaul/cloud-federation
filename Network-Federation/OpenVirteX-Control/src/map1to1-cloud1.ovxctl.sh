...
python ovxctl.py -n createSwitch ${t_id} 00:00:00:00:00:01:11:00
python ovxctl.py -n createSwitch ${t_id} 00:00:00:00:00:01:12:00
python ovxctl.py -n createSwitch ${t_id} 00:00:00:00:00:01:13:00
...
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:11:00 1
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:11:00 2
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:11:00 3
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:11:00 4

# Switch 3 (:13:00):
echo "Creating Ports (1,2,3) for SWITCH-2..."
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:12:00 1
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:12:00 2
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:12:00 3

# Switch 4 (:14:00):
echo "Creating Ports (1,2) for SWITCH-3..."
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:13:00 1
python ovxctl.py -n createPort ${t_id} 00:00:00:00:00:01:13:00 2
...
#python ovxctl.py -n connectLink ${t_id} 00:a4:23:05:00:01:10:00 2 00:a4:23:05:00:00:00:05 1 spf 1

# GW 1 <-> Switch 2:
echo "Connecting Link: (GW-1, Port 2) <-> (SWITCH-2, Port 3)..."
python ovxctl.py -n connectLink ${t_id} 00:a4:23:05:00:01:10:00 2 00:a4:23:05:00:01:11:00 3 spf 1

# Switch 2 <-> Switch 3:
echo "Connecting Link: (SWITCH-2, Port 4) <-> (SWITCH-3, Port 2)..."
python ovxctl.py -n connectLink ${t_id} 00:a4:23:05:00:01:11:00 4 00:a4:23:05:00:01:12:00 2 spf 1

# Switch 3 <-> Switch 4:
echo "Connecting Link: (SWITCH-3, Port 3) <-> (SWITCH-4, Port 2)..."
python ovxctl.py -n connectLink ${t_id} 00:a4:23:05:00:01:12:00 3 00:a4:23:05:00:01:13:00 2 spf 1


# Connect Hosts with Switches:
# GW 1 ([Port 1: Host DHCP])
#echo "Connecting Host: hdhcp <-> GW..."
#python ovxctl.py -n connectHost ${t_id} 00:a4:23:05:00:01:10:00 1 00:00:00:00:01:01

# Switch 1 ([Port 1: Host 1], [Port 2: Host 2]):
echo "Connecting Host: h1_1_1 <-> SWITCH-1..."
python ovxctl.py -n connectHost ${t_id} 00:a4:23:05:00:01:11:00 1 00:00:00:00:01:11
echo "Connecting Host: h1_1_2 <-> SWITCH-1..."
python ovxctl.py -n connectHost ${t_id} 00:a4:23:05:00:01:11:00 2 00:00:00:00:01:12

# Switch 2 ([Port 1: Host 3]):
echo "Connecting Host: h1_2_1 <-> SWITCH-2..."
python ovxctl.py -n connectHost ${t_id} 00:a4:23:05:00:01:12:00 1 00:00:00:00:01:13

# Switch 3 ([Port 1: Host 4]):
echo "Connecting Host: h1_3_1 <-> SWITCH-3..."
python ovxctl.py -n connectHost ${t_id} 00:a4:23:05:00:01:13:00 1 00:00:00:00:01:14
