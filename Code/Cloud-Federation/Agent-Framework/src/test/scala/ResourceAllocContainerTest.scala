 ...
 */
class ResourceAllocContainerTest extends AssertionsForJUnit
{
	@Test
	def compareResourceContainer(): Unit ={
		val nodeIDs1 			= Vector[NodeID](new NodeID(1),new NodeID(2))
		val res1 : ResourceAlloc = new ResourceAlloc(	nodeIDs1,
		...
		val res2 : ResourceAlloc = new ResourceAlloc(	nodeIDs2,
